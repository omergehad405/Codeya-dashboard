  ...
  useEffect(() => {
    if (service) {
      setFormData({
        ...
        suitedFor: service.suitedFor || '',
        builtToAchieve: (service.builtToAchieve && service.builtToAchieve.length > 0)
          ? [...service.builtToAchieve]
          : [''],
        canInclude: (service.canInclude && service.canInclude.length > 0)
          ? [...service.canInclude]
          : ['']
      });
    }
        ...
        <>
          ...
          >
            ...
            <div className="relative p-8 pb-4 border-b border-brand-border/60">
              ...
              <h2 className="font-serif text-2xl font-bold text-brand-dark">Edit Service</h2>
              <p className="text-sm font-medium text-[#6b8a78] mt-1">
                Update service details, deliverables, target audience, and capabilities.
              </p>
            </div>
