        ...
        <>
          ...
          >
            <div className="relative p-8 pb-4">
              ...
              <h2 className="font-serif text-2xl font-bold text-brand-dark">Edit Testimonial</h2>
              <p className="text-sm font-medium text-[#6b8a78] mt-1">Update client review details.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 pt-4 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="text-[11px] font-bold uppercase tracking-wider text-[#6b8a78] ml-1">Client Image (Leave empty to keep current)</label>
                  <div className="relative group">
                    <input
                      type="file"
                      accept="image/*"
